...
export const projects = [
  ...
  },
  {
    ...
    title: 'Uber',
    category: 'SaaS Explainer',
    description: 'A motion concept for Uber that takes users through the process of booking a ride. The animation focused on smooth transitions and app UI interactions to make the experience feel intuitive and engaging. The goal was to show how the app simplifies the process of getting from point A to point B while highlighting key features.',
  ...
  },
  {
    ...
    description: 'A short ui animation made for apple music. Focused on showcasing the smooth transitions.',
  ...
  },
{
    ...
    category: 'UI Animation',
    shortUiAnimation: true,
    description: 'A short ui animation made for dropbox. Focused on showcasing smooth transitions.',
  ...
  },
  {
    ...
    category: 'UI Animation',
    shortUiAnimation: true,
    description: 'A short ui animation made for instagram. Focused on showcasing smooth transitions.',
